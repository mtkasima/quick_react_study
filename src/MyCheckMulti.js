      ...
      <form>
        <fieldset>
          ...
          <input id="fruit_apple" name="fruit" type="checkbox" value="apple"
                 checked={this.state.fruit.includes('apple')} onChange={this.handleChangeMulti}/>
          <br/>
          <label htmlFor="fruit_orange">オレンジ</label>
          <input id="fruit_orange" name="fruit" type="checkbox" value="orange"
                 checked={this.state.fruit.includes('orange')} onChange={this.handleChangeMulti}/>
          <br/>
          <label htmlFor="fruit_melon">メロン</label>
          <input id="fruit_melon" name="fruit" type="checkbox" value="melon"
                 checked={this.state.fruit.includes('melon')} onChange={this.handleChangeMulti}/>
          <br/>
